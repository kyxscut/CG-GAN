...
class ConcatLmdbDataset(Dataset):
    def __init__(self, dataset_list, batchsize_list, 
        ...
        for i in range(len(dataset_list)):
            ...
            self.datasets.append(lmdbDataset(dataset_list[i], self.font_path, self.corpus, transform_img,transform_target_img, alphabet))
...
class lmdbDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        with self.env.begin(write=False) as txn:
            ...
            'A_label': label, 'B_label': label_target,'root':self.root}
